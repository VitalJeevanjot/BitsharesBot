...
const Buffer = require("safe-buffer").Buffer; // hash for .25 second
...
const key = {
  ...
  random32ByteBuffer(entropy = this.browserEntropy()) {
    ...
    while (Date.now() - start_t < HASH_POWER_MILLS) entropy = (0, _hash.sha256)(entropy);
  ...
  addresses(pubkey, address_prefix = (0, _addressPrefix.getAddressPrefix)()) {
