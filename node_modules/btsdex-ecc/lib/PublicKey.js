...
class PublicKey {
  ...
  toString(address_prefix = (0, _addressPrefix.getAddressPrefix)()) {
  ...
  toPublicKeyString(address_prefix = (0, _addressPrefix.getAddressPrefix)()) {
    var pub_buf = this.toBuffer();
  ...
  static fromPublicKeyString(public_key, address_prefix = (0, _addressPrefix.getAddressPrefix)()) {
    try {
  ...
  static fromStringOrThrow(public_key, address_prefix = (0, _addressPrefix.getAddressPrefix)()) {
  ...
  toAddressString(address_prefix = (0, _addressPrefix.getAddressPrefix)()) {
    var pub_buf = this.toBuffer();
    var pub_sha = (0, _hash.sha512)(pub_buf);
